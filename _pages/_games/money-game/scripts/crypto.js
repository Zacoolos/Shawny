...
function updateCrypto() {
    if (money < 100000000 && cryptoAccountOpened) {
        if (money >= 0) {
            ...
            console.log(`The crypto_percentage variable is: ${crypto_percentage}`)
        ...
        if (!cryptoAccountWasClosed) {
            ...
            cryptoGains.push('Your crypto account has been closed by Crypto Market LTD. Reason: You are too rich.');
            addAction('Crypto Market LTD close your crypto account');
        }
    }
}
